...
## 功能介绍
### 1.3
* 支持 EPUB 2/3 文件，保留章节排版、图片、基础 CSS 和原生目录
* EPUB 阅读界面可左键打开脚注及内部/外部链接，滚动到章节边界时继续切换章节
* TXT 继续使用原有分页模式；EPUB 阅读界面右键返回书架、中键打开目录

### 1.2
* 增加小说章节目录，打开小说后点击鼠标中键可以查看当前小说的章节，跳页功能从设置移动到章节目录页中
* 主页增加阅读进度、文件搜索、右键功能及列表排序方式和筛选等
* 分页和阅读记录等功能优化
* 修改图标
